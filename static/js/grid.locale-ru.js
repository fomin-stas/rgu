...
$.extend($.jgrid,{
	...
	search : {
		caption: "Расширенный поиск по свойствам полномочий",
		Find: "Найти",
		Reset: "Сброс",
		...
		operandTitle : "Выбор операции поиска.",
		resetTitle : "Сбросить параметр поиска"
	},
	edit : {
	...
	nav : {
		edittext: " ",
		edittitle: "Редактировать выбранные записи",
		addtext:" ",
		addtitle: "Добавить новую запись",
		deltext: " ",
		deltitle: "Удалить выбранные записи",
		searchtext: " ",
		...
		viewtext: "",
		viewtitle: "Просмотреть выбранные записи"
	},
	col : {

...
SELECT pg_catalog.setval('activity_feed_id_activity_feed_seq', 1, false);
...
SELECT pg_catalog.setval('authority_id_authority_seq', 1, false);
...
SELECT pg_catalog.setval('authority_property_id_authority_property_seq', 1, false);
...
SELECT pg_catalog.setval('authority_status_id_authority_status_seq', 1, true);
...
COPY property (id_property, id_property_type, id_service_type, property_name, code, options, property_short_name) FROM stdin;
4	5	7	Свойство 1	\N	{"property_align":"left","property_width":"90","property_required":"on","property_color":"#ffffff"}	\N
5	4	7	Свойство 2	\N	{"property_align":"left","property_width":"100","property_required":"on","property_color":"#9e1818"}	\N
6	1	6	Hello 5	\N	{"property_align":"center","property_width":"200","property_required":false,"property_color":"#ffffff"}	hell
\.
...
SELECT pg_catalog.setval('property_id_property_seq', 6, true);

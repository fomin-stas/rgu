...
SELECT pg_catalog.setval('activity_feed_id_activity_feed_seq', 72, true);
...
SELECT pg_catalog.setval('authority_id_authority_seq', 8522, true);
...
SELECT pg_catalog.setval('authority_property_id_authority_property_seq', 50625, true);
...
SELECT pg_catalog.setval('comment_id_comment_seq', 116, true);
...
SELECT pg_catalog.setval('history_log_id_history_log_seq', 53, true);
...
SELECT pg_catalog.setval('service_id_service_seq', 5681, true);
...
SELECT pg_catalog.setval('service_property_id_service_property_seq', 53902, true);

...
create table activity_feed (
   id_activity_feed     INT4                 not null,
...
create table authority_property (
   id_authority_property INT4                 not null,
...
create table authority_status (
   id_authority_status  INT4                 not null,
...
create table organization_rank (
   id_organization_rank INT4                 not null,
...
create table property_format (
   id_property_format   INT4                 not null,
...
create table service_property (
   id_service_property  INT4                 not null,
   id_property          INT4                 null,

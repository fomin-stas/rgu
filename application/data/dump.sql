...
SELECT pg_catalog.setval('auto_id_users', 172, true);
...
73	2	7	Наименование услуги	service_name	\N
74	2	7	Краткое наименование услуги	short_service_name	\N
75	2	7	Наименование органов, участвующих в предоставлении услуги	organization_provide_service	\N
12	1	6	Статус согласования статуса полномочия	authority_status	\N
8	3	6	Статус исполняемости	executable_status	\N
5	2	\N	Реквизиты НПА, которыми полномочие передано для осуществления ИОГВ субъекта РФ с федерального уровня	rekvisit_npa	\N
\.

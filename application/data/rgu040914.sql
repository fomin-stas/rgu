...
SELECT pg_catalog.setval('activity_feed_id_activity_feed_seq', 1, true);
...
1	25	1	В установленном порядке согласовывать переустройство и(или) перепланировку жилых помещений
\.
...
SELECT pg_catalog.setval('authority_id_authority_seq', 1, true);
...
SELECT pg_catalog.setval('authority_property_id_authority_property_seq', 3, true);
...
SELECT pg_catalog.setval('authority_status_id_authority_status_seq', 1, false);
...
SELECT pg_catalog.setval('event_type_id_event_type_seq', 1, false);
...
SELECT pg_catalog.setval('files_id_file_seq', 1, false);
...
SELECT pg_catalog.setval('history_log_id_history_log_seq', 1, false);
...
SELECT pg_catalog.setval('organization_rank_id_organization_rank_seq', 1, false);
...
COPY property (id_property, id_property_type, id_service_type, property_name, property_short_name, code, options) FROM stdin;
10	2	6	Наименование ИОГВ СПб	Наименование ИОГВ СПб	name_iogv	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
4	2	6	Основание/ Дата внесения изменений в Положение	Основание/ Дата внесения изменений в Положение	\N	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
75	2	7	Наименование органов, участвующих в предоставлении услуги	Наименование органов, участвующих в предоставлении услуги	sr_3	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
74	2	7	Краткое наименование услуги	Краткое наименование услуги	sr_1	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
11	1	6	id полномочия	id полномочия	id_authority	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
5	2	6	Реквизиты НПА	Реквизиты НПА	rekvisit_npa	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
174	2	7	Перечень НПА РФ, регулирующих предоставление услуги	Перечень НПА РФ	sr_4	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
173	3	7	Сфера предоставления\r\n\nСфера предоставления\r\n\nСфера предоставления\r\n\nСфера предоставления	Сфера предоставления	sr_2	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
73	2	7	Наименование услуги	Наименование услуги	sr_0\r\nsr_1\r\nsr_3\r\nsr_2\r\nsr_4\r\nsr_5\r\nsr_6\r\nsr_7\r\nsr_9\r\nsr_10\r\nsr_11\r\nsr_8\r\nsr_12\r\nsr_13\r\nsr_14\r\nsr_15\r\nsr_16\r\nsr_17\r\nsr_18\r\nsr_19\r\nsr_20\r\nsr_21\r\nsr_22\r\nsr_23\r\n	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
8	3	6	Статус исполняемости	Статус исполняемости	executable_status	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
13	2	6	Наименование полномочия в соответствии с Положением об ИОГВ	Наименование полномочия в соответствии с Положением об ИОГВ	name_authority	{"property_align":"left","property_width":"450","property_required":false,"property_color":"#6e5858"}
7	2	6	№ пункта в положении об ИОГВ	№ пункта в положении об ИОГВ	punkt_iogv	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
72	4	6	Cрок ответа	Cрок ответа	srok_otveta	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
18	3	6	субъект предоставления услуг (физ/юр)	субъект предоставления услуг (физ/юр)	service_subject	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
15	1	6	Статус разработки услуги/функции	Статус разработки услуги/функции	service_status	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
12	1	6	Статус согласования статуса полномочия	Статус согласования статуса полномочия	authority_status	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
17	3	6	Тип	Тип	service_type	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
16	2	6	Наименование государственной функций (услуги) в соответствии с административным регламентом	Наименование государственной функций	service_name	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
14	1	6	id государственной услуги/функции	id государственной услуги/функции	id_service	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
3	2	6	Внесены изменения в Положение об ИОГВ	Внесены изменения в Положение об ИОГВ	igov_changes	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
1	3	6	РЕЕСТР	РЕЕСТР	register	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
191	2	7	Сведения о порядке досудебного обжалования решений органа предоставляющего услугу		sr_21	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
186	2	7	Способы получения этих документов		sr_16	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
184	2	7	Основания для приостановления предоставления либо отказа в предоставлении услуги		sr_14	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
175	2	7	Перечень НПА СПб		sr_5	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
179	2	7	Категория заявителей	Категория заявителей	sr_10	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
178	2	7	Тип заявителя	Тип заявителя	sr_9	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
177	2	7	Результат предоставления услуги	Результат предоставления услуги	sr_7	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
176	2	7	Способы предоставления услуги	Способы предоставления услуги	sr_6	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
193	2	7	Технологическая карта межведомственного взаимодействия 		sr_23	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
192	2	7	Наличие межведомственного взаимодействия		sr_22	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
190	2	7	Информация о внутриведомственных и межведомственных процедурах		sr_20	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
189	2	7	Показатели доступности и качества услуги		sr_19	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
188	2	7	Стоимость услуги		sr_18	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
187	2	7	Сведения о возмездности услуги		sr_17	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
185	2	7	Перечень необходимых документов		sr_15	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
183	2	7	Максимальный срок ожидания в очереди		sr_13	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
182	2	7	Срок, в течение которого заявление должно быть зарегистрировано		sr_12	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
181	2	7	Срок предоставления		sr_8	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
180	2	7	Сведения о местах, в которых можно получить информацию		sr_11	{"property_align":"left","property_width":"200","property_required":false,"property_color":"#6e5858"}
\.
...
SELECT pg_catalog.setval('property_format_id_property_format_seq', 1, false);
...
SELECT pg_catalog.setval('property_id_property_seq', 2, true);
...
SELECT pg_catalog.setval('service_id_service_seq', 1, false);
...
SELECT pg_catalog.setval('service_property_id_service_property_seq', 1, false);
...
SELECT pg_catalog.setval('service_type_id_service_type_seq', 1, false);
